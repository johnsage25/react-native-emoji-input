...
import Search from 'react-native-emoji-input/src/svg/Search';
import BackSpace from 'react-native-emoji-input/src/svg/Backspace';
                        ...
                        <TouchableWithoutFeedback>
                            <Animatable.View
                                ...
                                <View style={{ flexDirection: 'row', justifyContent: 'center', alignContent: 'center' }}>
                                    <TouchableOpacity>
                                        <Search height={23} width={23} fill={'#868686'} />
                                    </TouchableOpacity>
                                    <View style={{ width: 1, height: 18, marginVertical: 2, backgroundColor: '#868686', marginLeft: 9 }} ></View>
                                </View>
                                ...
                                <View style={{ flexDirection: 'row', justifyContent: 'center', alignContent: 'center' }}>
                                    <View style={{ width: 1, height: 18, marginVertical: 2, backgroundColor: '#868686', marginRight: 9 }} ></View>
                                    <TouchableOpacity onPress={this.handleBackSpace}>
                                        <BackSpace height={23} width={23} fill={'#868686'} />
                                    </TouchableOpacity>
                                </View>
